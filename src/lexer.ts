...
const JS_BLOCK_LEXER_TOKEN_NAMES = {
  ...
  START_JS_TEMPLATE_STRING:
    LEXER_STATE_NAMES.JS_BLOCK + "_startJsTemplateString",
  ...
  CAPTURE_EVERYTHING_ELSE:
    LEXER_STATE_NAMES.JS_BLOCK + "_captureEverythingElse",
};
...
const JS_TEMPLATE_STRING_LEXER_TOKEN_NAMES = {
  ...
  ESCAPED_DOLLAR_BRACE:
    LEXER_STATE_NAMES.JS_TEMPLATE_STRING + "_escapedDollarBrace",
  ...
  CAPTURE_EVERYTHING_ELSE:
    LEXER_STATE_NAMES.JS_TEMPLATE_STRING + "_captureEverythingElse",
};

const INNER_SQL_BLOCK_LEXER_TOKEN_NAMES = {
  STATEMENT_SEPERATOR:
    LEXER_STATE_NAMES.INNER_SQL_BLOCK + "_statementSeparator",
  ...
  START_JS_PLACEHOLDER:
    LEXER_STATE_NAMES.INNER_SQL_BLOCK + "_startJsPlaceholder",
...
const SQL_SINGLE_QUOTE_STRING_LEXER_TOKEN_NAMES = {
  ESCAPED_BACKSLASH:
    LEXER_STATE_NAMES.SQL_SINGLE_QUOTE_STRING + "_escapedBackslash",
  ESCAPED_QUOTE:
    LEXER_STATE_NAMES.SQL_SINGLE_QUOTE_STRING + "_escapedQuoteSingle",
  START_JS_PLACEHOLDER:
    LEXER_STATE_NAMES.SQL_SINGLE_QUOTE_STRING + "_startJsPlaceholder",
  CLOSE_QUOTE: LEXER_STATE_NAMES.SQL_SINGLE_QUOTE_STRING + "_closeQuoteSingle",
  CAPTURE_EVERYTHING_ELSE:
    LEXER_STATE_NAMES.SQL_SINGLE_QUOTE_STRING + "_captureEverythingElse",
};

const SQL_DOUBLE_QUOTE_STRING_LEXER_TOKEN_NAMES = {
  ESCAPED_BACKSLASH:
    LEXER_STATE_NAMES.SQL_DOUBLE_QUOTE_STRING + "_escapedBackslash",
  ESCAPED_QUOTE:
    LEXER_STATE_NAMES.SQL_DOUBLE_QUOTE_STRING + "_escapedQuoteDouble",
  START_JS_PLACEHOLDER:
    LEXER_STATE_NAMES.SQL_DOUBLE_QUOTE_STRING + "_startJsPlaceholder",
...
const START_TOKEN_NODE_MAPPINGS = new Map<string, SyntaxTreeNodeType>([
  ...
  [
    SQL_LEXER_TOKEN_NAMES.START_QUOTE_SINGLE,
  ...
  [
    JS_TEMPLATE_STRING_LEXER_TOKEN_NAMES.START_JS_BLOCK,
  ...
  [
    INNER_SQL_BLOCK_LEXER_TOKEN_NAMES.START_QUOTE_SINGLE,
    SyntaxTreeNodeType.SQL_LITERAL_STRING,
  ],
  [
...
const WHOLE_TOKEN_NODE_MAPPINGS = new Map<string, SyntaxTreeNodeType>([
  ...
  [
    SQL_LEXER_TOKEN_NAMES.STATEMENT_SEPERATOR,
    SyntaxTreeNodeType.SQL_STATEMENT_SEPARATOR,
  ],

  [
    INNER_SQL_BLOCK_LEXER_TOKEN_NAMES.MULTI_LINE_COMMENT,
    SyntaxTreeNodeType.SQL_COMMENT,
  ],
  [
    INNER_SQL_BLOCK_LEXER_TOKEN_NAMES.SINGLE_LINE_COMMENT,
    SyntaxTreeNodeType.SQL_COMMENT,
  ],
  [
...
export class SyntaxTreeNode {
  public static create(code: string) {
    ...
    for (const token of lexer) {
      ...
      if (START_TOKEN_NODE_MAPPINGS.has(token.type)) {
        ...
        currentNode.push(
          new SyntaxTreeNode(WHOLE_TOKEN_NODE_MAPPINGS.get(token.type)!).push(
            token.value
          )
        );
      } else {
  ...
  public static isSyntaxTreeNode(
    node: string | SyntaxTreeNode
  ): node is SyntaxTreeNode {
  ...
  public concatenate(
    mutators?: Map<SyntaxTreeNodeType, (str: string) => string>
  ): string {
    const mutator = mutators?.has(this.type)
      ? mutators.get(this.type)!
      : (str: string) => str;
  ...
  public equals(other: SyntaxTreeNode): boolean {
    ...
    const areEqual = (
      first: string | SyntaxTreeNode,
      second: string | SyntaxTreeNode
    ) => {
    ...
    if (
      this.allChildren.some(
        (child, index) => !areEqual(child, other.children()[index])
      )
    ) {
      return false;
    }
...
function buildSqlxLexer(): { [x: string]: moo.Rules } {
  ...
  jsBlockLexer[JS_BLOCK_LEXER_TOKEN_NAMES.MULTI_LINE_COMMENT] =
    /\/\*[\s\S]*?\*\//;
  ...
  jsTemplateStringLexer[
    JS_TEMPLATE_STRING_LEXER_TOKEN_NAMES.ESCAPED_BACKSLASH
  ] = /\\\\/;
  jsTemplateStringLexer[
    JS_TEMPLATE_STRING_LEXER_TOKEN_NAMES.ESCAPED_DOLLAR_BRACE
  ] = /\\\${`/;
  jsTemplateStringLexer[JS_TEMPLATE_STRING_LEXER_TOKEN_NAMES.START_JS_BLOCK] = {
    match: "${",
    push: LEXER_STATE_NAMES.JS_BLOCK,
  };
  jsTemplateStringLexer[JS_TEMPLATE_STRING_LEXER_TOKEN_NAMES.CLOSE_STRING] = {
    match: "`",
    pop: 1,
  };
  jsTemplateStringLexer[
    JS_TEMPLATE_STRING_LEXER_TOKEN_NAMES.CAPTURE_EVERYTHING_ELSE
  ] = {
    match: /[\s\S]+?/,
    lineBreaks: true,
  };
  ...
  innerSqlBlockLexer[INNER_SQL_BLOCK_LEXER_TOKEN_NAMES.SINGLE_LINE_COMMENT] =
    /--.*?$/;
  innerSqlBlockLexer[INNER_SQL_BLOCK_LEXER_TOKEN_NAMES.MULTI_LINE_COMMENT] =
    /\/\*[\s\S]*?\*\//;
  ...
  innerSqlBlockLexer[
    INNER_SQL_BLOCK_LEXER_TOKEN_NAMES.CAPTURE_EVERYTHING_ELSE
  ] = {
    match: /[\s\S]+?/,
    lineBreaks: true,
  };
  ...
  innerSingleQuoteLexer[
    SQL_SINGLE_QUOTE_STRING_LEXER_TOKEN_NAMES.ESCAPED_BACKSLASH
  ] = "\\\\";
  innerSingleQuoteLexer[
    SQL_SINGLE_QUOTE_STRING_LEXER_TOKEN_NAMES.ESCAPED_QUOTE
  ] = "\\'";
  innerSingleQuoteLexer[
    SQL_SINGLE_QUOTE_STRING_LEXER_TOKEN_NAMES.START_JS_PLACEHOLDER
  ] = {
  ...
  innerSingleQuoteLexer[
    SQL_SINGLE_QUOTE_STRING_LEXER_TOKEN_NAMES.CAPTURE_EVERYTHING_ELSE
  ] = {
    match: /[\s\S]+?/,
    lineBreaks: true,
  };
  ...
  innerDoubleQuoteLexer[
    SQL_DOUBLE_QUOTE_STRING_LEXER_TOKEN_NAMES.ESCAPED_BACKSLASH
  ] = "\\\\";
  innerDoubleQuoteLexer[
    SQL_DOUBLE_QUOTE_STRING_LEXER_TOKEN_NAMES.ESCAPED_QUOTE
  ] = {
    match: '\\"',
  };
  innerSingleQuoteLexer[
  ...
  innerDoubleQuoteLexer[
    SQL_DOUBLE_QUOTE_STRING_LEXER_TOKEN_NAMES.CAPTURE_EVERYTHING_ELSE
  ] = {
    match: /[\s\S]+?/,
    lineBreaks: true,
  };
  ...
  lexerStates[LEXER_STATE_NAMES.SQL_SINGLE_QUOTE_STRING] =
    innerSingleQuoteLexer;
